 ...
 * @since       11.1
 */
class JControllerAdminUcm extends JController
{
	/**
	...
	public function delete()
	{
		...
		else
		{
			...
			foreach ($cid as $id)
			{
				$object = $factory->getContent($this->content_type)->load($id);
				$object->delete();
			}
	...
	public function publish()
	{
		...
		$cid = JRequest::getVar('cid', array(), '', 'array');
		$data = array('publish' => 1, 'unpublish' => 0, 'archive' => 2, 'trash' => -1, 'report' => -3);
		$task = $this->getTask();
	...
	public function checkin()
	{
		...
		foreach ($ids as $id)
		{
			$object = $factory->getContent($this->content_type)->load($id)->checkin();
		}
