...
<form action="<?php echo JRoute::_('index.php?option=com_contact'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<legend><?php echo JText::_('JSEARCH_FILTER_LABEL'); ?></legend>
		...
		<div class="filter-select">
			...
			<select name="filter_category_id" class="inputbox" onchange="this.form.submit()" id="filter_category_id" id="filter_access">
			...
			<select name="filter_access" class="inputbox" onchange="this.form.submit()" id="filter_language">
