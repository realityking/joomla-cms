...
<div id="step">
	<div class="buttons">
		<div class="button"><a href="index.php?view=filesystem" onclick="return Install.goToPage('filesystem');" rel="prev" title="<?php echo JText::_('JPrevious'); ?>"><?php echo JText::_('JPrevious'); ?></a></div>
...
<div id="installer">
	<form action="index.php" method="post" id="adminForm" class="form-validate cf">
