...
class InstallationModelSetup extends JModelBase
{
	...
	public function getForm($view = null)
	{
		...
		if (!$view)
		{
			$view = $app->input->getWord('view', 'language');
		}
	 ...
	 * Gets PHP options.
	 *
	 * @return  array  An array of PHP options.
	 *
	 * @since   3.0
	 */
	 ...
	 * Gets PHP Settings.
	 *
	 * @return  array  Array containing PHP configuration
	 *
	 * @since   3.0
	 */
...
/**
 * Methods below this line have not been reviewed for new MVC structure.
 */
	/**
	 * @return	array
	 * @since	1.6
